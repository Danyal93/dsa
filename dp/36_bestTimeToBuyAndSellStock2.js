...
function solve(prices, i, buy, dp) {
    ...
    if (buy) {
        ...
        let sellStock = prices[i] + solve(prices, i + 1, 1, dp)
...
function bestTimeToBuyAndSellStock2() { }
bestTimeToBuyAndSellStock2.run = function () {
    maxProfit([1, 3, 5])
}

module.exports = bestTimeToBuyAndSellStock2